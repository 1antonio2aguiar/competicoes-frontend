...
@Injectable()
export class LocaisCompeticoesSelectService extends BaseResourceService<LocaisCompeticoes>{
  ...
  listAll(): Observable<LocaisCompeticoes[]> {
    //console.log('Chegou no service! ',this.apiPath + '/list' )
    return this.http.get<LocaisCompeticoes[]>(this.apiPath + '/list'); // Retorna um Observable
  }
